...
def parse_args(args=None):
    ...
    reading.add_argument('-rand', dest='rand', action='store_true', help='Random past entry')
...
def guess_mode(args, config):
    ...
    if args.decrypt is not False or args.encrypt is not False or args.export is not False or any((args.short, args.tags, args.edit)):
        compose = False
        export = True
    elif any((args.start_date, args.end_date, args.on_date, args.limit, args.strict, args.starred, args.rand)):
...
def run(manual_args=None):
    ...
    if mode_compose:
        ...
        journal.limit(args.limit, args.rand)
